...
def assess_validity(
    *,
    ...
    open_signal_count = sum(1 for signal in OPEN_TEXT_SIGNALS if signal in text_norm)
    expired_signal_count = sum(1 for signal in EXPIRED_TEXT_SIGNALS if signal in text_norm)
